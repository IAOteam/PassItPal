        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <Button className="w-full text-base bg-blue-300 dark:bg-blue-400 hover:bg-blue-400 dark:hover:bg-blue-500 dark:text-white" size="lg" onClick={handleContactSeller}>
              ...
              <div className='flex justify-between items-center'>
                <div className="">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-3 group/seller rounded-lg hover:underline transition-colors"
                  >
                    <Avatar src={listing.seller.profilePictureUrl} icon={<UserOutlined />} />
                    <span className="font-medium text-sm text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">{listing.seller.username}</span>
                  </Link>
                </div>
