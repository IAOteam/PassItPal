          ...
          >
            <Panel header="How do I list my item?" key="1" >
              <p className="content-secondary">
                Once your account is set to <b>&ldquo;Seller&ldquo;</b> mode, click on{" "}
                <b>&ldquo;List a Pass&ldquo;</b> in the navigation bar and fill out the
        ...
        <div>
          ...
          >
            <Panel header="How do I buy an item?" key="3">
              <p className="content-secondary">
                Use the <b>&ldquo;Contact Seller&ldquo;</b> button on a listing to start a
